    ...
    <div class="container-fluid d-flex align-items-stretch justify-content-between">
        ...
        <div class="d-flex align-items-center flex-grow-1 flex-lg-grow-0">
            <a href="{{ route('dashboard') }}" class="d-lg-none">
                <img alt="Logo" src="{{ asset('assets/media/logos/logo-demo4-mobile.svg') }}" class="h-30px" />
            </a>
        </div>
        ...
        <div class="d-flex align-items-stretch justify-content-between flex-lg-grow-1">
            <div class="d-flex align-items-stretch" id="kt_header_nav">
                <div class="header-menu align-items-stretch" data-kt-drawer="true" data-kt-drawer-name="header-menu"
                    ...
                    <div class="menu menu-lg-rounded menu-column menu-lg-row menu-state-bg menu-title-gray-600 
                        menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-400 
                        fw-bold fs-6 my-5 my-lg-0 align-items-stretch"
                            ...
                            <div
                                ...
                                <div class="menu-item">
                                    <a class="menu-link py-3" href="{{ route('barang.index') }}">
                                        <span class="menu-icon">
                                            <i class="bi bi-box-seam fs-3"></i> <!-- Box icon for "Barang" -->
                                        </span>
                                ...
                                <div class="menu-item">
                                    <a class="menu-link py-3" href="{{ route('satuan.index') }}">
                                        <span class="menu-icon">
                                            <i class="bi bi-stack fs-3"></i> <!-- Stack icon for "Satuan" -->
                                        </span>
                                        <span class="menu-title">Satuan</span>
                                    </a>
                                </div>
                                <div class="menu-item">
                                    <a class="menu-link py-3" href="{{ route('vendor.index') }}">
                                        <span class="menu-icon">
                                            <i class="bi bi-person-lines-fill fs-3"></i>
                                            <!-- Person icon for "Vendor" -->
                                        </span>
                                ...
                                <div class="menu-item">
                                    <a class="menu-link py-3" href="{{ route('role.index') }}">
                                        <span class="menu-icon">
                                            <i class="bi bi-key fs-3"></i> <!-- Key icon for "Role" -->
                                        </span>
                                ...
                                <div class="menu-item">
                                    <a class="menu-link py-3" href="{{ route('user.index') }}">
                                        <span class="menu-icon">
                                            <i class="bi bi-people fs-3"></i> <!-- People icon for "User" -->
                                        </span>
